...
export default function ChairTicket() {
    return (
      <div className="container mx-auto bg-white rounded-lg shadow-lg p-6 border-t-4 border-yellow-500">
        ...
        <div className="mt-8 flex flex-col md:flex-row gap-4">
          ...
          <button className="w-full md:w-1/2 px-4 py-2 bg-orange-500 text-white rounded hover:bg-orange-600"><Link to = "/homepay">Tiếp tục</Link></button>
        </div>
      </div>
    );
  }