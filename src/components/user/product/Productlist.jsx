...
export default function ProductList() {
  ...
  return (
    ...
    <div className="font-[sans-serif] bg-white p-4 mx-auto max-w-[1400px]">
      <h2 className="text-xl sm:text-3xl font-extrabold text-gray-800 mb-6 sm:mb-8">Danh Sách Phim</h2>

      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
        <div className="group overflow-hidden cursor-pointer relative">
          <div className="bg-gray-100 w-full overflow-hidden">
            <img src="./product/mv1.jpg" alt="Product 1"
          ...
          <div className="p-4 relative">
            ...
            <div className="z-20 relative bg-white">
              <h6 className="text-sm font-semibold text-gray-800 truncate">Lexicon Luxe - Tshirt</h6>
              <h6 className="text-sm text-gray-600 mt-2">$100.00</h6>
            </div>
          </div>
        </div>
        ...
        <div className="group overflow-hidden cursor-pointer relative">
          <div className="bg-gray-100 w-full overflow-hidden">
            <img src="./product/mv2.jpg" alt="Product 2"
              className="aspect-[3/4] w-full object-cover object-top hover:scale-110 transition-all duration-700" />
          </div>
          ...
          <div className="p-4 relative">
            ...
            <div className="z-20 relative bg-white">
              <h6 className="text-sm font-semibold text-gray-800 truncate">Adjective Attire - Tshirt</h6>
        ...
        <div className="group overflow-hidden cursor-pointer relative">
          <div className="bg-gray-100 w-full overflow-hidden">
            <img src="./product/mv3.jpg" alt="Product 3"
              className="aspect-[3/4] w-full object-cover object-top hover:scale-110 transition-all duration-700" />
          </div>
          ...
          <div className="p-4 relative">
            ...
            <div className="z-20 relative bg-white">
              <h6 className="text-sm font-semibold text-gray-800 truncate">ThreadCraft Vibes - Tshirt</h6>
              <h6 className="text-sm text-gray-600 mt-2">$140.00</h6>
            </div>
          </div>
        </div>
        ...
        <div className="group overflow-hidden cursor-pointer relative">
          <div className="bg-gray-100 w-full overflow-hidden">
            <img src="./product/mv4.jpg" alt="Product 3"
              className="aspect-[3/4] w-full object-cover object-top hover:scale-110 transition-all duration-700" />
          </div>
          ...
          <div className="p-4 relative">
            ...
            <div className="z-20 relative bg-white">
              <h6 className="text-sm font-semibold text-gray-800 truncate">Verbal Vogue Tees - Tshirt</h6>
              <h6 className="text-sm text-gray-600 mt-2">$120.00</h6>
            </div>
          </div>
        </div>
        ...
        <div className="group overflow-hidden cursor-pointer relative">
          <div className="bg-gray-100 w-full overflow-hidden">
            <img src="./product/mv5.jpg" alt="Product 3"
              className="aspect-[3/4] w-full object-cover object-top hover:scale-110 transition-all duration-700" />
          </div>
          ...
          <div className="p-4 relative">
            ...
            <div className="z-20 relative bg-white">
              <h6 className="text-sm font-semibold text-gray-800 truncate">Jargon Jungle - Tshirt</h6>
              <h6 className="text-sm text-gray-600 mt-2">$150.00</h6>
            </div>
          </div>
        </div>
        ...
        <div className="group overflow-hidden cursor-pointer relative">
          <div className="bg-gray-100 w-full overflow-hidden">
            <img src="./product/mv6.jpg" alt="Product 3"
              className="aspect-[3/4] w-full object-cover object-top hover:scale-110 transition-all duration-700" />
          </div>
          ...
          <div className="p-4 relative">
            ...
            <div className="z-20 relative bg-white">
              <h6 className="text-sm font-semibold text-gray-800 truncate">Syllable Streetwear - Tshirt</h6>
              <h6 className="text-sm text-gray-600 mt-2">$140.00</h6>
            </div>
          </div>
        </div>
        ...
        <div className="group overflow-hidden cursor-pointer relative">
          <div className="bg-gray-100 w-full overflow-hidden">
            <img src="./product/mv7.jpg" alt="Product 3"
              className="aspect-[3/4] w-full object-cover object-top hover:scale-110 transition-all duration-700" />
          </div>
        ...
        <div className="group overflow-hidden cursor-pointer relative">
          <div className="bg-gray-100 w-full overflow-hidden">
            <img src="./product/mv8.jpg" alt="Product 3"
              className="aspect-[3/4] w-full object-cover object-top hover:scale-110 transition-all duration-700" />
          </div>
